...
python -u src/download_tessera.py \
        --start $START \
        --stop $END \
        --root_dir /lustre/scratch/WUR/AIN/tijun001/tessera_data \
        --cache_dir /lustre/scratch/WUR/AIN/tijun001/tessera_cache \
        --year 2024 \
        --size 128 


cp  /lustre/scratch/WUR/AIN/tijun001/tessera_data/data/tessera_2024/*.tif /lustre/backup/SHARED/AIN/embed_interpret/data/tessera_2024/